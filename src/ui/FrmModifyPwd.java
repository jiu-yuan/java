...
public class FrmModifyPwd extends JDialog implements ActionListener {
	...
	private JLabel labelPwd = new JLabel("新密码1：");
	private JLabel labelPwd2 = new JLabel("新密码2：");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				jz_util.user_manager.change_psd(user.currentLoginUser,new String(edtPwdOld.getPassword()),new String(edtPwd.getPassword()),new String(edtPwd2.getPassword()));
				this.setVisible(false);
